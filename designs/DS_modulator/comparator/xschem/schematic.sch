...
N 610 40 610 60 {lab=vout2}
N 610 -70 610 -20 {lab=vdd}
N 410 -70 540 -70 {lab=vdd}
N 600 10 610 10 {lab=vdd}
N 600 -20 600 10 {lab=vdd}
N 600 -20 610 -20 {lab=vdd}
N 750 -70 750 -30 {lab=vdd}
N 610 -70 750 -70 {lab=vdd}
N 750 -30 750 -20 {lab=vdd}
N 740 10 750 10 {lab=vdd}
N 740 -20 740 10 {lab=vdd}
N 740 -20 750 -20 {lab=vdd}
N 410 190 680 190 {lab=#net3}
N 750 40 750 190 {lab=#net3}
N 650 10 710 10 {lab=clk}
N 710 10 710 50 {lab=clk}
N 710 50 790 50 {lab=clk}
N 790 10 790 50 {lab=clk}
N 790 10 830 10 {lab=clk}
...
N -80 50 -80 180 {lab=#net2}
N -80 180 -80 190 {lab=#net2}
...
N 400 10 410 10 {lab=vdd}
N -80 190 210 190 {lab=#net2}
N 180 140 200 140 {lab=#net1}
N 180 140 180 290 {lab=#net1}
N 180 290 210 290 {lab=#net1}
N 410 290 440 290 {lab=#net1}
N 440 140 440 290 {lab=#net1}
N 420 140 440 140 {lab=#net1}
N 690 190 750 190 {lab=#net3}
N 680 190 690 190 {lab=#net3}
N 540 60 610 60 {lab=vout2}
N 540 -70 610 -70 {lab=vdd}
...
C {symbols/pfet_03v3.sym} 630 10 0 1 {name=M8
L=0.28u
W=2u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 770 10 0 1 {name=M9
L=0.28u
W=2u
nf=1
m=1
...
C {lab_pin.sym} 830 10 2 0 {name=p5 sig_type=std_logic lab=clk}
