...
N -260 40 -250 40 {lab=vin2}
N -270 40 -260 40 {lab=vin2}
N -160 -150 40 -150 {lab=vdd}
C {vsource.sym} -330 190 0 0 {name=V1 value=0.75 savecurrent=false}
C {vsource.sym} -270 190 0 0 {name=V2 value="PWL(0 0 500n 1.5)" savecurrent=false}
C {vsource.sym} -160 190 0 0 {name=V3 value=1.5 savecurrent=false}
...
C {lab_pin.sym} -270 120 0 0 {name=p4 sig_type=std_logic lab=vin2}
C {lab_pin.sym} -160 120 0 0 {name=p5 sig_type=std_logic lab=vdd
}
...
.save all
.endc"}
C {devices/code_shown.sym} 220 -90 0 0 {name=MODELS only_toplevel=true
