...
N 610 -330 610 -310 {lab=Vcd_up}
N 610 -330 670 -330 {lab=Vcd_up}
N 670 -330 670 -310 {lab=Vcd_up}
N 640 -360 640 -330 {lab=Vcd_up}
N 640 -320 640 -310 {lab=VDD}
N 640 -320 710 -320 {lab=VDD}
N 710 -320 710 -270 {lab=VDD}
...
C {lab_pin.sym} 710 -270 2 0 {name=p7 sig_type=std_logic lab=VDD}
